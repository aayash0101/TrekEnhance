class ApiEndpoints {
  ...
  // static const String serverAddress = "http://192.168.101.5:5000";
  ...
  static String updateProfileById(String userId) => "profile/$userId";  // PUT userBaseUrl + updateProfile
  ...
  // *** Added endpoints for saved and favorite journals by user ID ***
  static String getSavedJournalsByUserId(String userId) => "users/$userId/saved";
  static String getFavoriteJournalsByUserId(String userId) => "users/$userId/favorite";

  // You can add toggling endpoints similarly if needed:
  static String toggleSaveJournal(String userId, String journalId) =>
      "users/$userId/saved/$journalId";
  static String toggleFavoriteJournal(String userId, String journalId) =>
      "users/$userId/favorite/$journalId";
}
